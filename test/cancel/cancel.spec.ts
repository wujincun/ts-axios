...
describe('cancel:cancel', () => {
  test('should returns correct result when message is specified', () => {
    const cancel = new Cancel('Opreation has been canceled')
    expect(cancel.message).toBe('Opreation has been canceled')
  })
  test('should returns true if value is a Cancel', () => {
    expect(isCancel(new Cancel())).toBeTruthy()
  })
  test('should returns false if value is a not a Cancel', () => {
